...
export default function Home() {
	useEffect(() => {
		...
		const colors = ['#ffccd5', '#ffb3c1', '#ff758f', '#e00914', '#f67728', '#ff4d6d', '#ffb3c1', '#c9184a'];
		...
		function fillPattern() {
			...
			for (let i = 9; i > 0; i--) {
				tl.fromTo('#pattern_' + i, 0.3, { css: { fill: 'none' } }, { css: { fill: colors[i - 1] }, yoyo: true, ease: Power1.easeInOut }).fromTo(
					'#pattern_' + i,
					0.3,
					{ css: { autoAlpha: '0.3' } },
					{
			...
			tl.fromTo('#moon', 1, { attr: { fill: 'red' } }, { attr: { fill: '#251586' }, yoyo: true, ease: Power1.easeInOut }, '-=1').fromTo(
				'#moon',
				1,
				{ css: { autoAlpha: 0.6 } },
		...
		function outlinesPatternRight() {
			...
			tl.fromTo('#moon', 1, { css: { autoAlpha: 1 } }, { css: { autoAlpha: 0.4 }, yoyo: true, ease: Power1.easeInOut }, '-=1.5')
				.fromTo('#moon', 1, { attr: { fill: '#251586' } }, { attr: { fill: 'red' }, yoyo: true, ease: Power1.easeInOut }, '-=1')
				.fromTo('#moon', 1, { css: { scale: 0.6 } }, { scale: 1, yoyo: true, ease: Power1.easeInOut }, '-=1.5')
				.fromTo('#pattern_7', 1, { attr: { fill: 'none' } }, { attr: { fill: 'red' }, yoyo: true, ease: Power1.easeInOut }, '-=1.5');
		...
		function squeeze() {
			...
			for (let i = 8; i > 0; i--) {
				tl.fromTo('#pattern_' + i, 0.5, { css: { autoAlpha: 1 } }, { css: { autoAlpha: 0 }, ease: Power1.easeInOut }, '-=0.2');
			}
			tl.fromTo('#pattern_9', 1, { x: 0 }, { x: -150, ease: Power1.easeInOut }, '-=0.2').fromTo(
				'#pattern_9',
				1,
				{ css: { autoAlpha: '0.5' } },
	...
	return (
		<>
			...
			<header className="p-4 ml-2 text-2xl font-gabriela text-period-red">period.</header>
